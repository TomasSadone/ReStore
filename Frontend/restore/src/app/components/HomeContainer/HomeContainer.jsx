...
function HomeContainer({ data }) {
  ...
  return (
    <>
      <h4 className='text-2xl text-center mt-20 font-small text-blue-900'>
        Descuentos en Smartphones
      </h4>
      <Carousel className='mt-5' responsive={responsive}>
        {filteredData
          .filter((props) => Object.keys(props.subcategoria)[0] === 'Celulares')
          .map((props) => {
            return (
              <Card
                name={props.name}
      ...
      <h4 className='text-2xl text-center mt-20 font-small text-blue-900'>
        Descuentos en Computadoras
      </h4>
      <Carousel className='mt-5' responsive={responsive}>
        {filteredData
          .filter(
            (props) => Object.keys(props.subcategoria)[0] === 'Computacion'
          )
          .map((props) => {
            return (
              <Card
